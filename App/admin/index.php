  ...
  <div class="container">
    ...
    <div class="row" style="display: flex;">
      ...
      <div class="col-md-7 text-right">
        <h3 class="title-super text-uppercase text-thin" style="color: #686868c9;">Admin Portal</h3>
    ...
    <div class="row text-center" style="padding-left: 10px;">
      <div class="col-md-6">
        <img src="./stylesheets/support.jpg" class="img-responsive im">
        <h3>Allow Complaints</h3>
        <p>
          <form action="javascript:void(0);">
            <button onclick="next_page1()" >Next!!</button>
            <!-- <p id="demo1"></p> -->
          </form>
        </p>
      </div>
      <div class="col-md-6">
        <img src="./stylesheets/idea.jpg" class="img-responsive im">
        <h3>Allow Suggestions</h3>
        <p>
        <form action="javascript:void(0);">
          <button onclick="next_page2()">Next!!</button>
          <!-- <p id="demo2"></p> -->
        </form>
        </p>
      </div>
