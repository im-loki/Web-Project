...
<body onload="script:color_check();">
  ...
  <div class="container">
    ...
    <div class="row" style="display: flex;">
      <div class="col-md-5 title-logo"><img src="./stylesheets/bitlogo.png" class="img-responsive"></div>
      ...
      <div class="col-md-6">
        ...
        <p>
          <form action="javascript:void(0);">
            ...
            <button onclick="next_query1()" >Search</button>
          </form>
        </p>
      </div>
      <div class="col-md-6">
        ...
        <form action="javascript:void(0);">
          ...
          <button onclick="next_query2()">Search</button>
        </form>
        </p>
      </div>
    </div>
    ...
    <div class="row text-center" style="">
      <h2>Graphs</h2>
      <div class="col-md-6">
        <iframe src="new.php?q=complaints" style="border:none; width:425px; height:375px;"></iframe>
        <p>Graph: Type of complaints</p>
      </div>
      <div class="col-md-6">
        <iframe src="new.php?q=suggestions" style="border:none; width:425px; height:375px;" ></iframe>
        <p>Graph: Type of Suggestions</p>
      </div>
    </div>
    <hr style="background-color:gray;">
    <div class="row text-center">
